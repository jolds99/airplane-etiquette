...
The project utilized data that was collected by Walter Hickey from the website FiveThirtyEight in a survey of 1,041 airline travelers. This survey examined the flight behaviors and the perceived rudeness of those behaviors of these travelers. Our goal with the project was to answer the following four research questions using various statistical methods. 
